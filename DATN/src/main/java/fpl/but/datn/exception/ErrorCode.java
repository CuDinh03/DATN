...
public enum ErrorCode {
    ...
    NO_IMAGES_FOUND(2026, "Không tìm thấy danh sách Hinh anh nào",HttpStatus.NOT_FOUND ),
    ...
    MAUSAC_EXISTED(2030, "Màu sắc đã ton tai",HttpStatus.BAD_REQUEST),
    NO_KICHTHUOC_FOUND(2031, "Không tìm thấy danh sách kích thước nào ",HttpStatus.NOT_FOUND),
    KICHTHUOC_EXISTED(2032, "Kích thước đã ton tai",HttpStatus.BAD_REQUEST),

    NO_THUONGHIEU_FOUND(3031, "Không tìm thấy danh sách thương hiệu nào ",HttpStatus.NOT_FOUND),
    THUONGHIEU_EXISTED(3032, "Thương hiệu đã ton tai",HttpStatus.BAD_REQUEST),

    MA_MAUSAC_TRUNG(2027, "Trùng mã màu sắc", HttpStatus.BAD_REQUEST),
    LIST_COLOR_NOT_FOUND(2028, "Không tìm thấy danh sách màu", HttpStatus.NOT_FOUND),
    COLOR_NOT_FOUND(2029, "Màu sắc đang tìm không có", HttpStatus.NOT_FOUND),

    MA_KICHTHUOC_TRUNG(3030, "Trùng mã kich thước", HttpStatus.BAD_REQUEST),
    LIST_KICHTHUOC_NOT_FOUND(4031, "Không tìm thấy danh sách kích thước", HttpStatus.NOT_FOUND),
    KICHTHUOC_NOT_FOUND(4032, "Kích thước đang tìm không có", HttpStatus.NOT_FOUND),
