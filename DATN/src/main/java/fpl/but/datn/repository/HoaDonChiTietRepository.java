...
public interface HoaDonChiTietRepository extends JpaRepository<HoaDonChiTiet, UUID> {
    ...
    @Query(value = "SELECT hdct.* FROM hoa_don_chi_tiet hdct INNER JOIN hoa_don hd ON hdct.hoa_don_id = hd.id WHERE hd.id = :idHoaDon  hd.ngay_tao DESC", nativeQuery = true)
