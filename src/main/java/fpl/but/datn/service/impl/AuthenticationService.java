...
import fpl.but.datn.entity.InvalidatedToken;
import fpl.but.datn.entity.TaiKhoan;
import fpl.but.datn.exception.AppException;
import fpl.but.datn.exception.ErrorCode;
import fpl.but.datn.repository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse refreshToken(RefreshRequest request) throws ParseException, JOSEException {
        ...
        var taiKhoan =
                taiKhoanRepository.findByTenDangNhap(username).orElseThrow(() -> new AppException(ErrorCode.UNAUTHENTICATED));
